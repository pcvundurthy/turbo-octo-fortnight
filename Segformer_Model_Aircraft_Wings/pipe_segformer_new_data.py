...
data_path1 = "test_data"
mask_output_dir1 = "test_masks"
coco_data1 = json.load(open("labels_my-project-name_2025-04-04-05-29-43.json"))
dataset1 = create_binary_masks(data_path1, coco_data1, mask_output_dir1)



coco_data2 = json.load(open("labels_my-project-name_2025-04-04-05-29-43.json"))
dataset2 = create_binary_masks(data_path1, coco_data2, mask_output_dir1)
