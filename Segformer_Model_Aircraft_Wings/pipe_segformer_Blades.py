...
import os
for dirname, _, filenames in os.walk('Blades_segmentation'):
...
data_path1 = "Blades_suction_side"
mask_output_dir1 = "Blades_masks"
coco_data1 = json.load(open("Blades_suction_side/labels_my-project-name_2025-05-19-03-29-16.json"))
dataset1 = create_binary_masks(data_path1, coco_data1, mask_output_dir1)


data_path2="Blades_pressure_side"
coco_data2 = json.load(open("Blades_pressure_side/Blade_PressureSide.json"))
dataset2 = create_binary_masks(data_path2, coco_data2, mask_output_dir1)


print(len([file for file in os.listdir('Blades_masks') if file.lower().endswith('.png')]))
...
def overlay_predictions(model, loader, device, output_dir="predictions"):
    os.makedirs(output_dir, exist_ok=True)
    model.eval()
