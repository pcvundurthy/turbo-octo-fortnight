...
class Evaluator:
    def GetPascalVOCMetrics(self,
        ...
        for c in classes:
            ...
            #for key in gts:
                ...
                if iou >= IOUThreshold:
                    ...
                    acc_FN = acc_FN + 1  # count as false positive
            ...
            #print("dimensions of fn", fn_dim)
            #print("dimensions of tp", tp_dim)
            #print("dimensions of fp", fp_dim)
            ...
            ##############################################
            ##FN
            #df_fn = pd.DataFrame(fn_dim, columns=['image','label','confidence_score','BB_dimension'])
            #print(df_fn)
            print(len(fn_dim[1]))
            #print(len(fn_dim[1]))
            #print(fn_dim[2])
        ...
        return ret, images_fn, images_tp,images_fp,tp_dim, fp_dim
